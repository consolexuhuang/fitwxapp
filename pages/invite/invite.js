...
Page({
  ...
  getQrcode: function() {
    api.post('getQrcode').then(res => {
      ...
      this.setData({
        ...
        console.log(res.msg)
        // api.get('redirect', { url: res.msg }).then(res => {
        //   console.log('redirect', res)
        // })
        // this.setData({ ['postConfig.codeImg']: res.msg })        
  ...
  handleShadeTap: function(event) {
    const isShadeShow = false
    this.setData({
      isShadeShow
    })
  },
  handleShadeContentTap: function(event) {
    return
  },
  // 长摁识别
  distinguishImg(){
